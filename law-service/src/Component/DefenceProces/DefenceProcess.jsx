...
const DefenceProcess = () => {
    ...
    return (
        <div className='md:px-10 lg:px-20 '>
            ...
            <p><small>* Please note, the defence process outlined is a general guideline. Your specific case may require a tailored approach due to unique circumstances.*</small></p>
